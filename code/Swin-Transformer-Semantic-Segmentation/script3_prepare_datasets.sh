...
wget https://zenodo.org/record/5706578/files/Test.zip -P $FOLDER_NAME

wget https://zenodo.org/record/5706578/files/Train.zip -P $FOLDER_NAME

wget https://zenodo.org/record/5706578/files/Val.zip -P $FOLDER_NAME
